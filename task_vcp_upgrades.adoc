...
[.lead]
You can upgrade the NetApp Element Plug-in for vCenter Server by following the steps described for your installation. NetApp Element vCenter plug-in 5.5 is available outside of Element and NetApp HCI releases as part of a management services bundle.
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864[NetApp Element vCenter plug-in 5.5 Release Notes^]
...
*	https://docs.netapp.com/us-en/element-software/index.html[SolidFire and Element documentation resources^]
