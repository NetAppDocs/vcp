...
[.lead]
You can upgrade the NetApp Element Plug-in for VMware vCenter Server by following the steps described for your installation. Element vCenter plug-in 4.9 is available outside of Element software and NetApp HCI releases as part of a management services bundle.
