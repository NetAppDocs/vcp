...
[.lead]
You can edit a cluster running Element software, manage SSH configuration, set protection domain monitoring, and shut down a cluster from the plug-in extension point. Beginning with Element vCenter plug-in 5.0, you can use the NetApp Element Remote Plugin extension point. For Element vCenter plug-in 4.10 and earlier, you can use the NetApp Element Configuration extension point.
