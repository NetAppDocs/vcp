...
[.lead]
Documentation is also available for releases earlier than version 4.9 of the NetApp Element Plug-in for vCenter Server.

NOTE: This link:index.html[documentation link] for version 4.9 of the NetApp Element Plug-in for vCenter Server also includes versions 4.6, 4.7, and 4.8.

[cols=4*,options="header"]
|===
| Version | Plug-in release notes | Management services release notes | User guide

| 4.8 | https://library.netapp.com/ecm/ecm_download_file/ECMLP2881904[PDF^] | https://library.netapp.com/ecm/ecm_download_file/ECMLP2881904[2.20.xx^] | link:index.html[Link]
