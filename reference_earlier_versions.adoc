...
[.lead]
Documentation is also available for releases earlier than version 4.10 of the NetApp Element Plug-in for VMware vCenter Server.

NOTE: This link:index.html[documentation link] for Element vCenter plug-in 4.10 and also includes versions 4.9, 4.6, 4.7, and 4.8.
