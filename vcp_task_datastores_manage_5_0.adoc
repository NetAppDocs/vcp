---
sidebar: sidebar
permalink: vcp_task_datastores_manage_5_0.html
...
* To use QoSSIOC service with datastores, you must first link:vcp_task_getstarted_5_0.html#configure-qossioc-settings-using-the-plug-in[configure settings] on the QoSSIOC Settings page from plug-in extension point.
...
* To use QoSSIOC service with datastores, you must first link:vcp_task_getstarted_5_0.html#configure-qossioc-settings-using-the-plug-in[configure settings] on the QoSSIOC Settings page from the plug-in extension point.
...
+
If the QoSSIOC service is not available, first link:vcp_task_getstarted_5_0.html#configure-qossioc-settings-using-the-plug-in[configure QoSSIOC settings].
...
== View the datastore list
You can view available datastores on the Datastores page from the NetApp Element Remote Plugin extension point.
...
You can extend a datastore to increase volume size using the NetApp Element Remote Plugin extension point. Extending the datastore also extends the VMFS volume related to that datastore.
...
+
If the QoSSIOC service is not available, you must first link:vcp_task_getstarted_5_0.html#configure-qossioc-settings-using-the-plug-in[configure settings] on the QoSSIOC Settings page from the plug-in extension point.
...
You can share a datastore with one or more hosts using the NetApp Element Remote Plugin extension point.
...
== Delete a datastore
You can delete a datastore using the NetApp Element Remote Plugin extension point. This operation permanently deletes all the files associated with the VMs on the datastore that you want to delete. The plug-in does not delete datastores that contain registered VMs.
