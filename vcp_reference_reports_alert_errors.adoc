...
[.lead]
The system reports error codes with each alert on the Reporting > Alerts pages of the NetApp Element Plug-in for vCenter Server. Error codes help you determine what component of the system experienced the alert and why the alert was generated.
...
* *inconsistentInterfaceConfiguration*: The interface configuration is inconsistent.
+
*To resolve*: To resolve this fault, ensure the node interfaces in the storage cluster are consistently configured.
