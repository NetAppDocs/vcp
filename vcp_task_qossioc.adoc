...
[.lead]
You can set up QoSSIOC automation for individual volumes and datastores controlled by the plug-in. QoSSIOC is automatic quality of service (QoS) based on storage I/O control (SIOC) settings of all VMs on a standard datastore.
