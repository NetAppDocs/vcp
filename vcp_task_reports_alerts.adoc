...
You can view alerts on the Alerts page of the Reporting tab from the NetApp Element Management extension point.

Alerts are cluster faults or errors and are reported as they occur. Most errors resolve themselves automatically; however, some might require manual intervention.
...
* *Alert error codes*: The system reports error codes with each alert on the Alerts page. Error codes help you determine what component of the system experienced the alert and why the alert was generated. See link:vcp_reference_reports_alert_errors.html[System alerts list].
