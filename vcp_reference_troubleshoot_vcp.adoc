...
* <<Errors after NetApp Element Plug-in for vCenter Server 4.8 upgrade with VMware vCenter Server 6.7U1>>
...
After you upgrade to NetApp Element Plug-in for vCenter Server 4.8 with VMware vCenter Server 6.7U1, you might encounter the following issues:
...
. Log out of vCenter.
. After logging out, wait two to three minutes and then log back in.
