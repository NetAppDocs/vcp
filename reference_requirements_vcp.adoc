...
You also have the option to <<create_vcp_role,create a *VCProle* in vCenter>> for an Element plug-in user to give them permission to register or upgrade the Element Plug-in for vCenter Server and perform administration tasks.
...
For vCenter Servers 7.0 and 8.0, you can create a *VCProle* in vCenter to give an Element plug-in user permissions to register or upgrade the Element Plug-in for vCenter Server 
and perform Element plug-in administration tasks.
