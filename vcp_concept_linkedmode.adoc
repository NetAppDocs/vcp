...
NOTE: Using vCenter Linked Mode is not supported for NetApp Element Plug-in for vCenter Server 5.0. If your vCenter Server is version 5.0, see the link:vcp_concept_remote_plugin_extension_point.html[NetApp Element Remote Plugin] documentation.
