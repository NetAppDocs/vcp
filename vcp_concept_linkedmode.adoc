...
--
Beginning with Element Plug-in 5.0, you register the Element Plug-in from a separate management node for each vCenter Server that will be managing NetApp SolidFire storage clusters.
