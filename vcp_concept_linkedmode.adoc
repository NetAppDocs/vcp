...
NOTE: Beginning with Element Plug-in for vCenter Server 5.0, vCenter Linked Mode is not supported. If your vCenter Server is version 5.0 or later, see the link:vcp_concept_remote_plugin_extension_point.html[NetApp Element Remote Plugin] documentation.
