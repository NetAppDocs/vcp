...
You can view QoSSIOC events from the vCenter Plug-in extension point in NetApp Element Plug-in for vCenter Server.
...
+
* For Element Plug-in for vCenter Server 4.10 and earlier, select *NetApp Element Configuration > QoSSIOC Events*.
* Beginning with Element Plug-in for vCenter Server 5.0, select *NetApp Element Remote Plugin > Configuration > QoSSIOC Events*.
