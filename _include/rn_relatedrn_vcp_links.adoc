...
* https://library.netapp.com/ecm/ecm_download_file/ECMLPXXXXXXXX[vCenter Plug-in 5.0 Release Notes^]
...
== Compute firmware
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.146.html[Compute Firmware Bundle 2.146 Release Notes^] _NEW_
