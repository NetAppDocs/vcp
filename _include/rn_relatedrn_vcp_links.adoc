...
* https://library.netapp.com/ecm/ecm_download_file/ECMLPxxxxxxxx[vCenter Plug-in 4.8 Release Notes^]
...
== Compute firmware
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.76.html[Compute Firmware Bundle 2.76 Release Notes (latest)^]
