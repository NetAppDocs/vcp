...
[.lead]
NetApp Element Plug-in for vCenter Server 4.9 contains......

NetApp Element Plug-in for vCenter Server 4.9 is available with the 2.20 release of management services.
