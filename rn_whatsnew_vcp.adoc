...
[.lead]
There are no new enhancements in the Element vCenter plug-in 5.4 release. 

Element vCenter plug-in 5.3 is available with the 2.26.30 release of management services. link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3330676[Learn more^]
