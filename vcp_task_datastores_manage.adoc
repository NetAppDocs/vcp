...
* To use QoSSIOC service with datastores, you must first link:https://review.docs.netapp.com/us-en/vcp_vcp_migration_review/vcp_task_configure_qossioc.html[configure settings] on the QoSSIOC Settings page from the NetApp Element Configuration extension point.
