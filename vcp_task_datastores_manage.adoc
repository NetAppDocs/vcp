...
.. Add the volume to an access group that contains the one or more target hos initiators.
* To use CHAP:
...
*** Use an account with appropriate CHAP settings for each target hosts.
*** Create an account and configure target and initiator secrets.
