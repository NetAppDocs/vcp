...
iSCSI is the only supported protocol for NetApp Element software. Fibre Channel protocol is not supported. Protocol endpoints cannot be deleted or modified by a user, are not associated with an account, and cannot be added to a volume access group. On the *NetApp Element Management > VVols > Protocol Endpoints* or **NetApp Element Remote Plugin > Management > VVols > Protocol Endpoints* page, you can review protocol endpoint information.
...
Storage containers function like traditional accounts and can contain both virtual volumes and traditional volumes. A maximum of four storage containers per cluster is supported. A minimum of one storage container is required to use VVols functionality. On the *NetApp Element Management > VVols > Storage Containers* or **NetApp Element Remote Plugin > Management > VVols > Storage Containers* page, you can create, delete, and view details about storage containers. You can discover storage containers in vCenter during VVols creation.
