...
You can view the information for volumes that have been paired or are in the process of being paired on the Volume Pairs page of the Protection tab from the NetApp Element Management extension point for Element Plug-in for vCenter Server 4.10 and earlier and, beginning with Element Plug-in for vCenter Server 5.0, from the NetApp Element Remote Plugin extension point.
